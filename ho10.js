...
{
    stringOutput = " Password is too short please try again";
}
else 
{


for( i = 0; i < arrayBadPasswords.length; i++ ) // a for loop that repeats throught the whole length of Bad Password Arrays 
{
    if (stringPassword === arrayBadPasswords[i] ) // checks to see string Password is equal to array bad password 
    {
        stringOutput = "This password is not secure please choose a more secure password";
        // i = arrayBadPasswords.length; //how to do this a better way (ends the loop by making it equal to array Bad Password)
    break;
    }

    else 
    {
        stringOutput = " Congrats your password is secure";
